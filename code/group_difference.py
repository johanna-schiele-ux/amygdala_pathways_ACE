...
# ==============
# folder
csv_folder = Path("/home/amygdala/Desktop/Mannheim/network/stridex_output/csv/3_tracts/with_final_covariates")

# files containing fd/fc values of all tracts and covariates
